...
def run_model(Dz, Dy, times, days, H, Q, stack_y, stack_x, stacks, wind, y_slice, x_slice, output, stability_used, stab1, humidify, dry_size, aerosol_type, RH, x, y, dz, dxy, Mw, Ms, nu, rho_s):
    global AMMONIUM_NITRATE, ORGANIC_ACID
    global SULPHURIC_ACID, SODIUM_CHLORIDE, DRY_AEROSOL, HUMIDIFY, stability_str, ANNUAL_CYCLE
    global CONSTANT_STABILITY, THREE_STACKS, TWO_STACKS, ONE_STACK, PREVAILING_WIND, FLUCTUATING_WIND
    global CONSTANT_WIND, NO_PLOT, SURFACE_TIME, HEIGHT_SLICE, PLAN_VIEW
